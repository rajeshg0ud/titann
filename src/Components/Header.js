    ...
    <div className=' fixed top-0 w-full z-50'>
      <header className=' flex justify-between pt-2 sm:p-[10px] sm:pb-0 bg-white shadow-lg'>
        ...
        <div className=' flex sm:mr-10'>
          <p className=' px-4 flex flex-col items-center hover:cursor-pointer  size-14 sm:size-16 text-sm sm:text-md'><img src='https://www.titan.co.in/on/demandware.static/Sites-Titan-Site/-/default/dw1d6980ca/images/headerAccount.svg' />Login</p>
